...
if (isset($_POST["submit"])) {
   ...
   $sql = "INSERT INTO `students`(`id`, `full_name`, `nic`, `address`, `telephone`, `gender`, `email`) VALUES (NULL,'$full_name','$nic','$address','$telephone','$gender','$email')";

   $result = mysqli_query($conn, $sql);

   if ($result) {
      header("Location: home.php?msg=New student created successfully");
   } else {
         ...
         <form action="" method="post" style="width:50vw; min-width:300px;">
            <div class="row mb-3">
               ...
               <div class="col-md-6">
                  ...
                  <input type="text" class="form-control" name="nic" placeholder="National Identy Number" required>
               </div>
               <div class="col-6">
               ...
               <div class="col-6">
                  ...
                  <input type="text" class="form-control" name="telephone" placeholder="Telephone No" required>
               </div>
               <div class="col-md-12">
